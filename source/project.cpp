...
namespace DetectandTract{
    void projector::initParams(ros::NodeHandle &nh)
    {
        ...
        std::cout << __FILE__ <<":" << __LINE__  << i_params.cameraIn << std::endl;
        i_params.cameraIn.release();
        std::cout << __FILE__ <<":" << __LINE__  << i_params.cameraIn << std::endl;
        ...
        std::cout << __FILE__ <<":" << __LINE__ << i_params.RT<<std::endl;
                                        ...
                                        const geometry_msgs::PoseStamped::ConstPtr &pose_msg)
    {
        ...
        // pcl::toROSMsg(*rgb_pts_cloud, laserCloudmsg);
        // laserCloudmsg.header = pc->header;
        // pubLaserCloudFullRes.publish(laserCloudmsg);
        // ROS_WARN(" rgb pts size: %ld .", rgb_pts_cloud->points.size());
        // return;
    ...
    projector::projector() 
    {
        ...
        message_filters::Subscriber<geometry_msgs::PoseStamped> pose_sub(nh, i_params.pose_topic, 10000);

        // message_filters::Subscriber<sensor_msgs::PointCloud2> pcl_sub(nh, "/undistort_laser", 1000);
        // // message_filters::Subscriber<sensor_msgs::PointCloud2> pcl_sub(nh, "/livox_pc2", 1000);
        // message_filters::Subscriber<geometry_msgs::PoseStamped> pose_sub(nh, "/lidar_pose", 1000);
        ...
        message_filters::Synchronizer<MySyncPolicy> sync(MySyncPolicy(10000), image_sub, pcl_sub, pose_sub);
        sync.registerCallback(boost::bind(&projector::projection_callback, this, _1, _2, _3));
